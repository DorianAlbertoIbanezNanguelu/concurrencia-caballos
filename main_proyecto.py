...
# Archivo principal
    ...
    def __init__(self):
        ...
        self.ui.pushButton_caballo_1.setStyleSheet("background-image:url(descarga.jpg);background-repeat:no-repeat;background-position:center;")
        self.ui.pushButton_caballo_2.setStyleSheet("background-image:url(descarga.jpg);background-repeat:no-repeat;background-position:center;")
        self.ui.pushButton_caballo_3.setStyleSheet("background-image:url(descarga.jpg);background-repeat:no-repeat;background-position:center;")
        self.ui.pushButton_caballo_4.setStyleSheet("background-image:url(descarga.jpg);background-repeat:no-repeat;background-position:center;")
